            ...
            <div class="col-md-5">
                <div class="pet-pic-wrapper position-relative">
                    <img
                        ...
                        alt=""
                    />
                    <label for="petimg" type="button" class="file-btn"
            ...
            <div class="col-md-5 ms-5">
                ...
                <div class="input-data-wrapper">
                    ...
                    <InputFeild
                        label="Owner Name"
                        type="text"
                        placeholder="Sanudi Pinnawala"
                    />
                    <InputFeild
                        label="Contact No."
                        type="text"
                        placeholder="0715314148"
                    />
                    <InputFeild
                        label="E-Mail"
                        type="text"
                        placeholder="sanudisarithma1999@gmail.com"
                    />
                </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row pt-3" v-if="showQRcode">
                            <div class="col-md-8">
                                ...
                                ><i class="fa-solid fa-download pe-3"></i>Download
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mx-0 justify-content-end mt-5 pb-5">
                    <div class="col-md-8">
                        ...
                        <PrimaryButton
                            class="qr-btn submit-btn py-2 px-4 fw-semibold mx-2"
                            label="Submit"
                        />
                    </div>
                </div>
