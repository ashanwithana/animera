...
use App\Http\Controllers\Frontend\PetsController;
...
Route::get('/home', [HomeController::class, 'index'])->name('index');
  ...
  Route::get('/pets/add', [PetsController::class, 'create'])->name('addpet');
  ...
  Route::post('pets/update', [PetsController::class, 'update'])->name('pets.update');
  Route::post('pets/delete', [PetsController::class, 'destroy'])->name('pets.delete');
  Route::get('/pets/{id}/qr', [PetsController::class, 'generateQr'])->name('pets.qr');
  ...
  Route::get('/pet-history/{id}', [PetsController::class, 'history'])->name('pets.view');
  Route::get('/past-vaccines/{id}', [PetsController::class, 'PastVaccines'])->name('pvaccine');
  Route::get('/treatments/{id}', [PetsController::class, 'Treatments'])->name('treatments');
